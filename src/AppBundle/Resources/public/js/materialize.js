...
"undefined" == typeof jQuery &&
	...
	t.extend(t.easing, {
		...
		easeInElastic: function(t) {
			return 0 === t
				? 0
				: 1 === t ? 1 : -i(2, 10 * t - 10) * o((10 * t - 10.75) * c);
		},
				...
				return (function(t, e, i, n) {
					...
					function l(t, i, n, o) {
						...
						(t = Math.min(
							t,
							1
						)), (n = Math.min(n, 1)), (t = Math.max(t, 0)), (n = Math.max(n, 0));
						var C = k ? new Float32Array(b) : new Array(b),
							T = !1,
							S = function(e) {
								return T || f(), t === i && n === o
									? e
									: 0 === e ? 0 : 1 === e ? 1 : l(h(e), i, o);
							};
										...
										: v.isArray(t) && 2 === t.length
											...
											: !(!v.isArray(t) || 4 !== t.length) &&
												l.apply(
													null,
													t
												)), !1 === i && (i = b.Easings[b.defaults.easing] ? b.defaults.easing : y), i;
					}
					function u(t) {
						if (t) {
							...
							for (var a = 0; i > a; a++)
								if (b.State.calls[a]) {
									...
									c.display !== n &&
										"none" !== c.display &&
										(b.State.calls[a][2].display = !1), c.visibility !== n &&
										"hidden" !== c.visibility &&
										(b.State.calls[a][2].visibility = !1), c.progress &&
										c.progress.call(
											s[1],
											s[1],
											g,
						...
						for (
							...
							if (
								...
								p.each(k.Lists.transforms3D, function(t, e) {
									...
									((h = !0), delete r(d).transformCache.translate3d), h &&
									k.flushTransformCache(d), k.Values.removeClass(
									d,
									"velocity-animating"
								);
							}
						...
						);
					{
						if (!(7 >= h)) {
							...
							var w = (function() {
								...
								return function t(e, n, o) {
									var a,
										...
										u = 0;
									for (
										e = parseFloat(e) || 500, n = parseFloat(n) || 20, o =
											o || null, l.tension = e, l.friction = n, (a = null !== o)
											? ((u = t(e, n)), (r = u / o * 0.016))
											: (r = 0.016);
										(s = i(s || l, r)), c.push(1 + s.x), (u += 16), Math.abs(
											s.x
										) > 1e-4 && Math.abs(s.v) > 1e-4;
							...
							var k = (b.CSS = {
								...
								Hooks: {
									...
									cleanRootPropertyValue: function(t, e) {
										return k.RegEx.valueUnwrap.test(e) &&
											(e = e.match(
												k.RegEx.valueUnwrap
											)[1]), k.Values.isCSSNullValue(e) &&
											(e = k.Hooks.templates[t][1]), e;
									},
									...
									injectValue: function(t, e, i) {
										...
										if (n) {
											var o,
												a = n[0],
												r = n[1];
											return (i = k.Hooks.cleanRootPropertyValue(
												a,
												i
											)), (o = i.toString().match(k.RegEx.valueSplit)), (o[
												r
											] = e), o.join(" ");
										}
										return i;
								...
								Names: {
									...
									SVGAttribute: function(t) {
										...
										return (h || (b.State.isAndroid && !b.State.isChrome)) &&
											(e += "|transform"), new RegExp(
											"^(" + e + ")$",
											"i"
										).test(t);
									},
								...
								getPropertyValue: function(t, i, o, a) {
									...
									if (k.Hooks.registered[i]) {
										var c = i,
											u = k.Hooks.getRoot(c);
										o === n &&
											(o = k.getPropertyValue(t, k.Names.prefixCheck(u)[0])), k
											.Normalizations.registered[u] &&
											(o = k.Normalizations.registered[u](
												"extract",
												t,
												o
									...
									return k.Values.isCSSNullValue(l) && (l = 0), b.debug >= 2 &&
								...
								setPropertyValue: function(t, i, n, o, a) {
									...
									if ("scroll" === i)
										...
										k.Normalizations.registered[i]("inject", t, n), (s =
											"transform"), (n = r(t).transformCache[i]);
									else {
										if (k.Hooks.registered[i]) {
											var l = i,
												c = k.Hooks.getRoot(i);
											(o =
												o ||
												k.getPropertyValue(t, c)), (n = k.Hooks.injectValue(
												l,
												n,
												o
											)), (i = c);
										...
										if (
											(
												k.Normalizations.registered[i] &&
													(
														(n = k.Normalizations.registered[i](
															"inject",
															t,
															n
														)),
										...
										p.each(r(t).transformCache, function(t) {
											/^translate/i.test(t)
												...
												: /^scale/i.test(t)
													...
													: /^rotate/i.test(t) &&
														(t =
															"rotate"), n[t] && ((i += t + "(" + n[t].join(" ") + ") "), delete n[t]);
										});
									} else {
										var o, a;
										p.each(r(t).transformCache, function(e) {
											return (o = r(t).transformCache[
												e
							...
							k.Hooks.register(), k.Normalizations.register(), (b.hook = function(
								t,
								e,
								i
							) {
								...
								return (t = a(t)), p.each(t, function(t, a) {
									if ((r(a) === n && b.init(a), i === n))
										...
										"transform" === s[0] &&
											b.CSS.flushTransformCache(a), (o = s);
									}
								}), o;
							});
							var x = function() {
									...
									function t(t) {
										function d(t, e) {
											...
											return v.isArray(t)
												...
												: (i = t), e || (o = o || s.easing), v.isFunction(i) &&
												(i = i.call(a, T, C)), v.isFunction(r) &&
										...
										if ("scroll" === A) {
											...
											"none" === r(a).opts.display &&
												(r(a).opts.display = "auto"), "hidden" ===
												r(a).opts.visibility &&
												(r(a).opts.visibility = "visible"), (r(
												a
											).opts.loop = !1), (r(a).opts.begin = null), (r(
												a
											).opts.complete = null), y.easing ||
												delete s.easing, y.duration ||
												delete s.duration, (s = p.extend({}, r(a).opts, s));
											...
											for (var E in M)
												if ("element" !== E) {
													...
													(M[E].startValue = M[E].currentValue =
														M[E].endValue), (M[
														E
													].endValue = _), v.isEmptyObject(y) ||
														(M[E].easing = s.easing), b.debug &&
														console.log(
											...
											r(a).tweensContainer &&
												!0 === r(a).isAnimating &&
												(M = r(a).tweensContainer), p.each(m, function(t, e) {
												if (
														...
														if (0 === V) W = F;
															...
															o =
																...
																(function() {
																	...
																	(I.lastParent = t.myParent), (I.lastPosition =
																		t.position), (I.lastFontSize = t.fontSize);
																	var s = 100,
																		l = {};
																	if (o && n)
																		(l.emToPx =
																			I.lastEmToPx), (l.percentToPxWidth =
																			I.lastPercentToPxWidth), (l.percentToPxHeight =
																		...
																		var c = r(a).isSVG
																			...
																			: i.createElement("div");
																		b.init(c), t.myParent.appendChild(
																			c
																		), p.each(
																			...
																			(parseFloat(
																				k.getPropertyValue(c, "width", null, !0)
																			) || 1) /
																			s), (l.percentToPxHeight = I.lastPercentToPxHeight =
																			(parseFloat(
																				k.getPropertyValue(
																					c,
																					"height",
																			...
																			) || 1) / s), (l.emToPx = I.lastEmToPx =
																			(parseFloat(
																				k.getPropertyValue(c, "paddingLeft")
																			) || 1) / s), t.myParent.removeChild(c);
																	}
																	return null === I.remToPx &&
																		...
																		), (l.remToPx = I.remToPx), (l.vwToPx =
																		I.vwToPx), (l.vhToPx = I.vhToPx), b.debug >=
																		1 &&
																		console.log(
															...
															: v.isFunction(z.stagger) &&
																(z.delay =
																	...
																	z.stagger.call(
																		...
																		t,
																		C
																	)), z.drag && ((z.duration = parseFloat(E) || (/^(callout|transition)/.test(m) ? 1e3 : g)), (z.duration = Math.max(z.duration * (z.backwards ? 1 - t / C : (t + 1) / C), 0.75 * z.duration, 200))), b.Redirects[m].call(e, e, z || {}, t, C, f, P.promise ? P : n);
													}), t();
												}
												var M =
							...
							return b.State.isMobile ||
								...
								b.Redirects["slide" + e] = function(t, i, o, a, r, s) {
									...
									l.display === n &&
										...
										(h.overflow = t.style.overflow), (t.style.overflow =
											"hidden");
									}), (l.complete = function() {
								...
								b.Redirects["fade" + e] = function(t, i, o, a, r, s) {
									...
									(l.complete =
										...
										(l.display = "In" === e ? "auto" : "none"), b(this, c, l);
								};
							}), b;
						}
	...
	function c(t, e, i) {
		var n,
			o = e.prototype;
		((n = t.prototype = Object.create(o)).constructor = t), (n._super = o), i &&
			s(n, i);
	}
	function u(t, e) {
		return function() {
	...
	function T(t, e) {
		var i = this;
		(this.manager = t), (this.callback = e), (this.element =
			t.element), (this.target =
			t.options.inputTarget), (this.domHandler = function(e) {
	...
	function P(t, e, i) {
		var n = i.pointers.length,
			...
			a = e & xt && 0 == n - o,
			r = e & (Tt | St) && 0 == n - o;
		(i.isFirst = !!a), (i.isFinal = !!r), a &&
			(t.session = {}), (i.eventType = e), A(t, i), t.emit(
			"hammer.input",
			i
	...
	function A(t, e) {
		var i = t.session,
			n = e.pointers,
			o = n.length;
		i.firstInput || (i.firstInput = _(e)), o > 1 && !i.firstMultiple
			? (i.firstMultiple = _(e))
		...
		var a = i.firstInput,
			...
			l = (e.center = M(n));
		(e.timeStamp = ht()), (e.deltaTime =
			e.timeStamp - a.timeStamp), (e.angle = z(s, l)), (e.distance = q(
			s,
			l
		)), O(i, e), (e.offsetDirection = D(e.deltaX, e.deltaY)), (e.scale = r
			? H(r.pointers, n)
			: 1), (e.rotation = r ? V(r.pointers, n) : 0), E(i, e);
		var c = t.element;
	...
	function E(t, e) {
		...
		if (e.eventType != St && (l > kt || s.velocity === n)) {
			var c = s.deltaX - e.deltaX,
				u = s.deltaY - e.deltaY,
				d = I(l, c, u);
			(o = d.x), (a = d.y), (i = pt(d.x) > pt(d.y) ? d.x : d.y), (r = D(
				c,
				u
			)), (t.lastInterval = e);
		} else
	...
	function L() {
		(this.evEl = Ht), (this.evWin = Lt), (this.allow = !0), (this.pressed = !1), T.apply(
			this,
			arguments
		);
	}
	function j() {
		(this.evEl = Nt), (this.evWin = Wt), T.apply(
			this,
			arguments
		), (this.store = this.manager.session.pointerEvents = []);
	}
	function $() {
		(this.evTarget = Qt), (this.evWin = Xt), (this.started = !1), T.apply(
			this,
			arguments
		);
	}
	...
	function F(t, e) {
		...
		for (o = 0; o < r.length; )
			n[r[o].identifier] && s.push(r[o]), e & (Tt | St) &&
				delete n[r[o].identifier], o++;
		return s.length ? [w(a.concat(s), "identifier", !0), s] : void 0;
	}
	function Q() {
		T.apply(this, arguments);
		var t = u(this.handler, this);
		(this.touch = new W(this.manager, t)), (this.mouse = new L(
			this.manager,
			t
		));
	}
	...
	function Y(t) {
		(this.id = x()), (this.manager = null), (this.options = l(
			t || {},
			this.defaults
		)), (this.options.enable = p(
			this.options.enable,
			!0
		)), (this.state = ie), (this.simultaneous = {}), (this.requireFail = []);
	}
	function B(t) {
		return t & se
			? "cancel"
	...
	function at(t, e) {
		(e = e || {}), (this.options = l(
			...
			this.options.inputTarget ||
			t), (this.handlers = {}), (this.session = {}), (this.recognizers = []), (this.element = t), (this.input = S(
			this
		)), (this.touchAction = new X(this, this.options.touchAction)), rt(
			this,
			!0
		), r(
			e.recognizers,
	...
	T.prototype = {
		handler: function() {},
		init: function() {
			this.evEl && h(this.element, this.evEl, this.domHandler), this.evTarget &&
				h(this.target, this.evTarget, this.domHandler), this.evWin &&
				h(C(this.element), this.evWin, this.domHandler);
		},
		destroy: function() {
			this.evEl && f(this.element, this.evEl, this.domHandler), this.evTarget &&
				f(this.target, this.evTarget, this.domHandler), this.evWin &&
	...
	c(L, T, {
		handler: function(t) {
			var e = Vt[t.type];
			e & xt && 0 === t.button && (this.pressed = !0), e & Ct &&
				1 !== t.which &&
				(e = Tt), this.pressed &&
				this.allow &&
				(
		...
		handler: function(t) {
			...
			if ((e === xt && (this.started = !0), this.started)) {
				...
				e & (Tt | St) &&
					...
					(this.started = !1), this.callback(this.manager, e, {
					pointers: i[0],
					changedPointers: i[1],
					pointerType: bt,
					srcEvent: t
	...
	X.prototype = {
		set: function(t) {
			t == Gt && (t = this.compute()), Ut &&
				(this.manager.element.style[
					Bt
				] = t), (this.actions = t.toLowerCase().trim());
		},
		update: function() {
	...
	(Y.prototype = {
		defaults: {},
		set: function(t) {
			return s(this.options, t), this.manager &&
				this.manager.touchAction.update(), this;
		},
		recognizeWith: function(t) {
			if (a(t, "recognizeWith", this)) return this;
			var e = this.simultaneous;
			return (t = G(t, this)), e[t.id] ||
				((e[t.id] = t), t.recognizeWith(this)), this;
		},
		...
		requireFailure: function(t) {
			...
			return (t = G(t, this)), -1 === y(e, t) &&
				(e.push(t), t.requireFailure(this)), this;
		},
			...
			return o & e.direction ||
				(e.direction & Mt
					...
					: (
							...
							(i = r != this.pY),
							(n = Math.abs(t.deltaY))
						)), (t.direction = o), i && n > e.threshold && o & e.direction;
		},
		attrTest: function(t) {
			return (
		...
		emit: function(t) {
			...
			var e = U(t.direction);
			e && this.manager.emit(this.options.event + e, t), this._super.emit.call(
				this,
				t
			);
		}
		...
		attrTest: function(t) {
			...
			return i & (Mt | It)
				...
				: i & Mt
					? (e = t.velocityX)
					: i & It && (e = t.velocityY), this._super.attrTest.call(this, t) &&
				i & t.direction &&
		...
		emit: function(t) {
			var e = U(t.direction);
			e && this.manager.emit(this.options.event + e, t), this.manager.emit(
				this.options.event,
				t
			);
		}
	...
	(at.prototype = {
		set: function(t) {
			return s(this.options, t), t.touchAction &&
				this.touchAction.update(), t.inputTarget &&
				(
					this.input.destroy(),
		...
		recognize: function(t) {
			...
			if (!e.stopped) {
				...
				for (var a = 0; a < n.length; )
					(i = n[a]), 2 === e.stopped || (o && i != o && !i.canRecognizeWith(o))
						? i.reset()
						: i.recognize(t), !o &&
						i.state & (ne | oe | ae) &&
						(o = e.curRecognizer = i), a++;
			}
		},
		get: function(t) {
...
})(window), "undefined" == typeof exports ||
	exports.nodeType ||
	(
	...
	for (
		...
		(n = t[i[a] + "RequestAnimationFrame"]), (o =
			t[i[a] + "CancelRequestAnimationFrame"]);
	(n && o) ||
		(
			(n = function(t) {
				var i = +Date.now(),
...
Materialize.throttle = function(t, e, i) {
	...
	i || (i = {});
	var l = function() {
		(s = !1 === i.leading ? 0 : getTime()), (r = null), (a = t.apply(
			n,
			o
		)), (n = o = null);
	};
	return function() {
		...
		return (n = this), (o = arguments), u <= 0
			...
			: r || !1 === i.trailing || (r = setTimeout(l, u)), a;
	};
};
var Vel;
(Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity), (Materialize.Vel =
	Vel || Velocity), (function(t) {
	(t.fn.collapsible = function(e, i) {
		...
		return (e = t.extend(n, e)), this.each(function() {
			function n(e) {
				(p = d.find(
				...
				)), e.hasClass("active") ? e.parent().addClass("active") : e.parent().removeClass("active"), e
					.parent()
					.hasClass("active")
					? e.siblings(".collapsible-body").stop(!0, !1).slideDown({
							duration: 350,
							easing: "easeOutQuart",
							queue: !1,
							complete: function() {
					...
					t(this).is(":visible") &&
						t(this).slideUp({
							...
							complete: function() {
								t(this).css("height", ""), s(
									t(this).siblings(".collapsible-header")
								);
							}
						});
				});
			...
			function a(e) {
				e.hasClass("active")
					...
					: e.parent().removeClass("active"), e.parent().hasClass("active")
					? e.siblings(".collapsible-body").stop(!0, !1).slideDown({
							duration: 350,
							easing: "easeOutQuart",
							queue: !1,
			...
			function r(t, i) {
				i ||
					t.toggleClass(
						"active"
					), e.accordion || "accordion" === h || void 0 === h ? n(t) : a(t), s(t);
			}
			function s(t) {
				t.hasClass("active")
			...
			if ("destroy" !== o)
				if (i >= 0 && i < p.length) {
					...
					u(), d.on("click.collapse", "> li > .collapsible-header", function(
						e
					) {
						var i = t(e.target);
						l(i) && (i = c(i)), r(i);
				...
				: void this.each(function() {
						function n() {
							void 0 !== r.data("induration") &&
								(s.inDuration = r.data(
									"induration"
								)), void 0 !== r.data("outduration") && (s.outDuration = r.data("outduration")), void 0 !== r.data("constrainwidth") && (s.constrainWidth = r.data("constrainwidth")), void 0 !== r.data("hover") && (s.hover = r.data("hover")), void 0 !== r.data("gutter") && (s.gutter = r.data("gutter")), void 0 !== r.data("beloworigin") && (s.belowOrigin = r.data("beloworigin")), void 0 !== r.data("alignment") && (s.alignment = r.data("alignment")), void 0 !== r.data("stoppropagation") && (s.stopPropagation = r.data("stoppropagation"));
						}
						function o(e) {
							"focus" === e &&
								(l = !0), n(), c.addClass("active"), r.addClass("active");
							...
							"left" === h
								...
								: "right" === h &&
									...
									), c.css({ position: "absolute", top: r.position().top + m + g, left: v + y }), c
								.slideDown({
									queue: !1,
	...
	var i = {
		...
		n = (function() {
			function n(e, i) {
				_classCallCheck(this, n), e[0].M_Modal &&
					e[0].M_Modal.destroy(), (this.$el = e), (this.options = t.extend(
					{},
					n.defaults,
					i
				)), (this.isOpen = !1), (this.$el[0].M_Modal = this), (this.id = e.attr(
					"id"
				)), (this.openingTrigger = void 0), (this.$overlay = t(
					'<div class="modal-overlay"></div>'
				)), n._increment++, n._count++, (this.$overlay[0].style.zIndex =
					1e3 + 2 * n._increment), (this.$el[0].style.zIndex =
					1e3 + 2 * n._increment + 1), this.setupEventHandlers();
			}
			return _createClass(
				n,
				[
					...
					},
					{
						key: "destroy",
						value: function() {
							this.removeEventHandlers(), this.$el[0].removeAttribute(
								"style"
							), this.$overlay[0].parentNode &&
								this.$overlay[0].parentNode.removeChild(
									this.$overlay[0]
								), (this.$el[0].M_Modal = void 0), n._count--;
						}
					},
					{
					...
					},
					{
						...
						value: function() {
							...
							var i = {
								...
								ease: "easeOutCubic",
								complete: function() {
									(t.$el[0].style.display = "none"), "function" ==
					...
					},
					{
						...
						value: function(t) {
							if (!this.isOpen) {
								this.isOpen = !0;
								var e = document.body;
								return (e.style.overflow = "hidden"), this.$el[0].classList.add(
									"open"
								), e.appendChild(this.$overlay[0]), (this.openingTrigger =
									t || void 0), this.options.dismissible &&
									(
					...
					},
					{
						...
						value: function() {
							if (this.isOpen)
								return (this.isOpen = !1), this.$el[0].classList.remove(
									"open"
								), (document.body.style.overflow = ""), this.options
									.dismissible &&
	...
	(n._increment = 0), (n._count = 0), (Materialize.Modal = n), (t.fn.modal = function(
		e
	) {
		...
		return this.each(function() {
			function e() {
				...
				s.velocity(
					"stop",
					!0
				), t("#materialbox-overlay").velocity("stop", !0), t(".materialbox-caption").velocity("stop", !0), t(window).off("scroll.materialbox"), t(document).off("keyup.materialbox"), t(window).off("resize.materialbox"), t(
					"#materialbox-overlay"
				).velocity(
					{ opacity: 0 },
					{
					...
					{ width: n, height: l, left: 0, top: 0 },
					{
						...
						complete: function() {
							e.css({
								...
								top: "",
								left: ""
							}), s.removeAttr("style"), s.attr("style", c), s.removeClass(
								"active"
							), (a = !0), i && i.css("overflow", "");
						}
					}
			...
			if (!t(this).hasClass("initialized")) {
				...
				s.wrap(l), s.on("click", function() {
					...
					u / l > d / c
						? ((m = 0.9 * l), (g = 0.9 * l * (d / u)))
						: ((m = 0.9 * c * (u / d)), (g = 0.9 * c)), s.hasClass(
						"responsive-img"
					)
						? s.velocity(
								{ "max-width": m, width: u },
		...
		init: function(e) {
			...
			return this.each(function(i) {
				...
				e.swipeable &&
					...
					(e.swipeable = !1), 0 === (o = t(p.filter('[href="' + location.hash + '"]'))).length && (o = t(this).find("li.tab a.active").first()), 0 === o.length && (o = t(this).find("li.tab a").first()), o.addClass("active"), (m = p.index(o)) < 0 && (m = 0), void 0 !== o[0] && (a = t(o[0].hash)).addClass("active"), u.find(".indicator").length || u.append('<li class="indicator"></li>'), (s = u.find(".indicator")), u.append(s), u.is(
					":visible"
				) &&
					setTimeout(function() {
					...
					? (
							...
							t(".tabs-content.carousel").carousel({
								...
								onCycleTo: function(t) {
									if (!y) {
										var i = m;
										(m = r.index(t)), o.removeClass("active"), (o = p.eq(
											m
										)).addClass("active"), k(i), "function" ==
											typeof e.onShow && e.onShow.call(u[0], a);
									}
								}
							})
						)
					...
					if (t(this).parent().hasClass("disabled")) i.preventDefault();
						...
						(y = !0), (h = u.width()), (v =
							Math.max(h, u[0].scrollWidth) / p.length), o.removeClass(
							"active"
						);
						var n = a;
						(o = t(this)), (a = t(
						...
						o.position();
						o.addClass("active"), (g = m), (m = p.index(t(this))) < 0 &&
							(m = 0), e.swipeable
							? f.length &&
	...
	t.fn.tooltip = function(i) {
		...
		return "remove" === i
			? (
					this.each(function() {
						t(
							"#" + t(this).attr("data-tooltip-id")
						).remove(), t(this).removeAttr("data-tooltip-id"), t(this).off("mouseenter.tooltip mouseleave.tooltip");
					}),
					!1
				)
			: (
					...
					this.each(function() {
						...
						o.attr("data-tooltip-id") &&
							t(
								"#" + o.attr("data-tooltip-id")
							).remove(), o.attr("data-tooltip-id", n);
						var a,
							r,
							s,
							l,
							...
							d = function() {
								(a = o.attr("data-html")
									...
									: i.html), (r = o.attr("data-delay")), (r =
									void 0 === r || "" === r ? i.delay : r), (s = o.attr(
									"data-position"
								)), (s =
									void 0 === s || "" === s ? i.position : s), (l = o.attr(
									"data-tooltip"
										...
										: "left" === s
											...
											: "right" === s
												...
												: (
													...
													), c.css({ top: n.y, left: n.x }), (y = Math.SQRT2 * p / parseInt(m)), (b = Math.SQRT2 * l / parseInt(g)), (w = Math.max(y, b)), c.velocity({ translateY: f, translateX: v }, { duration: 350, queue: !1 }).velocity({ opacity: 1 }, { duration: 300, delay: 50, queue: !1 }), u.css({ visibility: "visible" }).velocity({ opacity: 1 }, { duration: 55, delay: 0, queue: !1 }).velocity({ scaleX: w, scaleY: w }, { duration: 300, delay: 0, queue: !1, easing: "easeInOutQuad" });
								}, r);
							},
	...
	var e = function(e, i, n, o) {
		...
		return a < 0
			? (a = 4)
			: a + n > window.innerWidth && (a -= a + n - window.innerWidth), r < 0
			? (r = 4)
	...
	function n(t) {
		...
		return (e = a.documentElement), void 0 !== t.getBoundingClientRect &&
			(o = t.getBoundingClientRect()), (n = i(a)), {
		...
		c = {
			...
			show: function(t, e) {
				...
				"touches" in t &&
					...
					), a.setAttribute("data-hold", Date.now()), a.setAttribute(
					"data-scale",
					u
				), a.setAttribute("data-x", l), a.setAttribute("data-y", s);
				var d = { top: s + "px", left: l + "px" };
				(a.className = a.className + " waves-notransition"), a.setAttribute(
					"style",
					o(d)
				), (a.className = a.className.replace("waves-notransition", "")), (d[
					"-webkit-transform"
				] = u), (d["-moz-transform"] = u), (d["-ms-transform"] = u), (d[
					"-o-transform"
				] = u), (d.transform = u), (d.opacity = "1"), (d[
					"-webkit-transition-duration"
				] =
					c.duration + "ms"), (d["-moz-transition-duration"] =
					c.duration + "ms"), (d["-o-transition-duration"] =
					c.duration + "ms"), (d["transition-duration"] =
					c.duration + "ms"), (d["-webkit-transition-timing-function"] =
					"cubic-bezier(0.250, 0.460, 0.450, 0.940)"), (d[
					...
					"cubic-bezier(0.250, 0.460, 0.450, 0.940)"), a.setAttribute(
					"style",
					o(d)
				);
			},
			...
			wrapInput: function(t) {
				for (var e = 0; e < t.length; e++) {
					...
					if ("input" === i.tagName.toLowerCase()) {
						...
						a || (a = ""), o.setAttribute("style", a), (i.className =
							"waves-button-input"), i.removeAttribute("style"), n.replaceChild(
							o,
							i
						), o.appendChild(i);
					}
			...
			allowEvent: function(t) {
				...
				return "touchstart" === t.type
					...
					: "touchend" === t.type || "touchcancel" === t.type
						...
						: "mousedown" === t.type && u.touches > 0 && (e = !1), e;
			},
			touchup: function(t) {
				u.allowEvent(t);
			}
	...
	(s.displayEffect = function(e) {
		"duration" in (e = e || {}) && (c.duration = e.duration), c.wrapInput(
			l(".waves-effect")
		), "ontouchstart" in t &&
			document.body.addEventListener(
				"touchstart",
		...
		"input" === e.tagName.toLowerCase() &&
			(c.wrapInput([e]), (e = e.parentNode)), "ontouchstart" in t &&
			e.addEventListener("touchstart", r, !1), e.addEventListener(
			"mousedown",
			r,
			!1
		);
	}), (t.Waves = s), document.addEventListener(
		"DOMContentLoaded",
		function() {
			s.displayEffect();
		},
			...
			function n(e, i, o, a) {
				if ((_classCallCheck(this, n), e)) {
					(this.options = {
						...
						n.defaults,
						this.options
					)), (this.message = e), (this.panning = !1), (this.timeRemaining = this.options.displayLength), 0 ===
						n._toasts.length && n._createContainer(), n._toasts.push(this);
						...
						value: function() {
							...
							: this.message &&
								...
								: this.message instanceof jQuery
									...
									: (e.innerHTML = this.message), n._container.appendChild(
								e
							), e;
						}
					},
						...
						value: function() {
							...
							this.timeRemaining !== 1 / 0 &&
								(this.counterInterval = setInterval(function() {
									t.panning ||
										(t.timeRemaining -= 20), t.timeRemaining <= 0 && t.remove();
								}, 20));
						}
					},
					{
								...
								{ opacity: 0, marginTop: "-40px" },
								{
									...
									complete: function() {
										"function" == typeof t.options.completeCallback &&
											t.options.completeCallback(), t.el.parentNode.removeChild(
											t.el
										), n._toasts.splice(n._toasts.indexOf(t), 1), 0 ===
											n._toasts.length && n._removeContainer();
									}
								}
							);
						}
					...
					},
					{
						...
						value: function(e) {
							if (e.target && t(e.target).closest(".toast").length) {
								...
								(i.panning = !0), (n._draggedToast = i), i.el.classList.add(
									"panning"
								), (i.el.style.transition = ""), (i.startingXPos = n._xPos(
									e
								)), (i.time = Date.now()), (i.xPos = n._xPos(e));
							}
						}
					},
					{
						...
						value: function(t) {
							if (n._draggedToast) {
								...
								(e.deltaX = Math.abs(e.xPos - n._xPos(t))), (e.xPos = n._xPos(
									t
								)), (e.velocityX =
									e.deltaX / (Date.now() - e.time)), (e.time = Date.now());
								var i = e.xPos - e.startingXPos,
									o = e.el.offsetWidth * e.options.activationPercent;
								(e.el.style.transform =
									"translateX(" + i + "px)"), (e.el.style.opacity =
									1 - Math.abs(i / o));
							}
						}
					},
	...
	(n._toasts = []), (n._container = null), (n._draggedToast = null), (Materialize.Toast = n), (Materialize.toast = function(
		t,
		e,
		i,
		o
		...
		init: function(e) {
			...
			(e = t.extend(i, e)), t(this).each(function() {
				...
				e.draggable
					...
					: (a = t()), "left" == e.edge ? (o.css("transform", "translateX(-100%)"), a.css({ left: 0 })) : (o.addClass("right-aligned").css("transform", "translateX(100%)"), a.css({ right: 0 })), o.hasClass("fixed") && window.innerWidth > 992 && o.css("transform", "translateX(0)"), o.hasClass(
					"fixed"
				) &&
					t(window).resize(function() {
				...
				var r = function(i) {
						(s = !1), (l = !1), t("body").css({ overflow: "", width: "" }), t(
							"#sidenav-overlay"
						).velocity(
							{ opacity: 0 },
							{
							...
							? (
									...
									o.velocity(
										{ translateX: "-100%" },
										{
											...
											complete: function() {
												!0 === i &&
													(o.removeAttr("style"), o.css("width", e.menuWidth));
											}
										}
									)
								)
				...
				e.draggable &&
														...
														{ opacity: 0 },
														{
															...
															complete: function() {
																"function" == typeof e.onClose &&
																	e.onClose.call(this, o), t(this).remove();
															}
														}
													),
					...
					if (!0 === l) (l = !1), (s = !1), r();
						...
						var i = t("body"),
							...
							c = i.innerWidth();
						i.css("overflow", "hidden"), i.width(c), t("body").append(
							a
						), "left" === e.edge
							? (
									a.css({ width: "50%", right: 0, left: "" }),
	...
	function i(i) {
		...
		t.each(d, function(t, e) {
			"number" != typeof e.data("scrollSpy:ticks") &&
				e.triggerHandler("scrollSpy:enter"), e.data("scrollSpy:ticks", l);
	...
	(t.scrollSpy = function(e, n) {
		...
		(e = t(e)).each(function(e, i) {
			a.push(t(i)), t(i).data("scrollSpy:id", e), t(
				'a[href="#' + t(i).attr("id") + '"]'
			).click(function(e) {
				e.preventDefault();
		...
		}), (c.top = n.offsetTop || 0), (c.right = n.offsetRight || 0), (c.bottom =
			n.offsetBottom || 0), (c.left = n.offsetLeft || 0);
		...
		return s || (o.on("scroll", d), o.on("resize", d), (s = !0)), setTimeout(
			d,
			0
		...
		return (t.winSizeSpy = function() {
			return o;
		}), (e = e || { throttle: 100 }), o.on(
			"resize",
			Materialize.throttle(n, e.throttle || 100)
		);
	...
	t(document).ready(function() {
		function e(e) {
			...
			o &&
				n.css(
					"font-size",
					o
				), i && n.css("font-family", i), a && n.css("line-height", a), r && n.css("padding", r), e.data("original-height") || e.data("original-height", e.height()), "off" === e.attr("wrap") && n.css("overflow-wrap", "normal").css("white-space", "pre"), n.text(e.val() + "\n");
			var s = n.html().replace(/\n/g, "<br>");
			n.html(
				s
			), e.is(":visible") ? n.css("width", e.width()) : n.css("width", t(window).width() / 2), e.data("original-height") <= n.height() ? e.css("height", n.height()) : e.val().length < e.data("previous-length") && e.css("height", e.data("original-height")), e.data("previous-length", e.val().length);
		}
		...
		t(document).on("change", i, function() {
			(0 === t(this).val().length && void 0 === t(this).attr("placeholder")) ||
				t(this).siblings("label").addClass("active"), validate_field(t(this));
		}), t(document).ready(function() {
			...
			0 === e.val().length &&
				...
				(i +=
					", label"), e.siblings(i).removeClass("active"), validate_field(e);
		...
		t(
			document
		).on("keyup.radio", "input[type=radio], input[type=checkbox]", function(e) {
			if (9 === e.which)
		...
		t(".materialize-textarea").each(function() {
			...
			"body"
		).on("keyup keydown autoresize", ".materialize-textarea", function() {
			e(t(this));
		...
		t(document).on("change", o, function(e) {
			...
			if (a) {
				i.hasClass("active") || r(i);
				var l = s(n);
				i.addClass("active").css("left", l), i
					.find(".value")
					.html(i.siblings(o).val());
			}
			...
			return (e = t.extend(i, e)), this.each(function() {
				...
				if (t.isEmptyObject(o)) n.off("keyup.autocomplete focus.autocomplete");
					...
					s.length
						? (l = s.children(".autocomplete-content.dropdown-content").first())
								.length || s.append(c)
						: (l = n.next(".autocomplete-content.dropdown-content")).length ||
							n.after(c), l.length && (c = l);
					var u = function(t, e) {
							var i = e.find("img"),
					...
					n.off("blur.autocomplete").on("blur.autocomplete", function() {
									...
									for (var l in o)
										if (
											...
											o[l]
												...
												: d.append("<span>" + l + "</span>"), c.append(d), u(
												s,
												d
											), a++;
										}
						...
						.on(
							...
							function() {
								...
								n.val(i), n.trigger("change"), p(), "function" ==
									typeof e.onAutocomplete && e.onAutocomplete.call(this, i);
							}
						);
				}
			});
		...
		function i(t, e, i) {
			var o = t.indexOf(e),
				a = -1 === o;
			return a ? t.push(e) : t.splice(o, 1), i
				.siblings("ul.dropdown-content")
				.find("li:not(.optgroup)")
				.eq(e)
				.toggleClass("active"), i.find("option").eq(e).prop("selected", a), n(
				t,
				i
			), a;
		}
		function n(t, e) {
			...
			"" === i && (i = e.find("option:disabled").eq(0).text()), e
			...
			if (!n.hasClass("browser-default")) {
				...
				if (
					...
					return n
						...
						.removeClass("initialized"), void t(window).off("click.select");
				var r = Materialize.guid();
				n.attr("data-select-id", r);
				var s = t('<div class="select-wrapper"></div>');
				s.addClass(n.attr("class")), n.is(":disabled") &&
					s.addClass("disabled");
				var l = t(
				...
				c.length &&
					...
					t(this).click(function(r) {
						if (
							...
							o
								? (
										t('input[type="checkbox"]', this).prop("checked", function(
											t,
											e
										) {
											return !e;
								...
								.find("option")
								.eq(a)
								.prop("selected", s), n.trigger("change"), void 0 !== e && e();
						}
						r.stopPropagation();
					});
				}), n.wrap(s);
				...
				n.before(m), m.before(f), m.after(l), n.is(":disabled") ||
					m.dropdown({ hover: !1 }), n.attr("tabindex") &&
					t(m[0]).attr("tabindex", n.attr("tabindex")), n.addClass(
					"initialized"
				), m.on({
					focus: function() {
						if (
							...
							if (13 != e.which || l.is(":visible")) {
								...
								40 == e.which &&
									(
										...
										g(l, r)
									), 27 == e.which && m.trigger("close"), 38 == e.which &&
									(r = l.find("li.selected").prev("li:not(.disabled)")[0]) &&
									g(l, r), setTimeout(function() {
									y = [];
								}, 1e3);
							}
						} else m.trigger("open");
	...
	var e = {
		init: function(e) {
			...
			return (e = t.extend(i, e)), this.each(function() {
				...
				function n(t) {
					t >= c.length ? (t = 0) : t < 0 && (t = c.length - 1), (u = l
						.find(".active")
						.index()) != t &&
						(
							(o = c.eq(u)),
				...
				-1 != u &&
					(o = c.eq(
						u
					)), s.hasClass("fullscreen") || (e.indicators ? s.height(e.height + 40) : s.height(e.height), l.height(e.height)), c.find(".caption").each(function() {
					i(t(this), 0);
					...
					(
						...
						c.each(function(i) {
							...
							o.click(function() {
								n(
									l.parent().find(t(this)).index()
								), clearInterval(r), (r = setInterval(function() {
									(u = l
										.find(".active")
										.index()), c.length == u + 1 ? (u = 0) : (u += 1), n(u);
								}, e.transition + e.interval));
							}), a.append(o);
						}),
						s.append(a),
						(a = s.find("ul.indicators").find("li.indicator-item"))
					), o ? o.show() : (c.first().addClass("active").velocity({ opacity: 1 }, { duration: e.transition, queue: !1, easing: "easeOutQuad" }), (u = 0), (o = c.eq(u)), e.indicators && a.eq(u).addClass("active")), o.find("img").each(function() {
					o
						.find(".caption")
						.velocity(
							{ opacity: 1, translateX: 0, translateY: 0 },
				...
				s
					...
					.on("pan", function(t) {
						if ("touch" === t.gesture.pointerType) {
							...
							($curr_slide = l.find(".active")), Math.abs(n) > Math.abs(o) &&
								$curr_slide.velocity(
									{ translateX: i },
									{ duration: 50, queue: !1, easing: "easeOutQuad" }
		...
		t(document).on("click.card", ".card", function(e) {
			if (t(this).find("> .card-reveal").length) {
				...
				t(e.target).is(t(".card-reveal .card-title i"))
					? t(this).find(".card-reveal").velocity(
							{ translateY: 0 },
							{
								duration: 225,
								queue: !1,
		...
		(n.hasAutocomplete = !t.isEmptyObject(
			...
			n.$document
				...
				if (!t(i.target).is("input, textarea")) {
					...
					if (a.length)
						if (8 === i.which || 46 === i.which) {
							...
							var l = null;
							o + 1 < s ? (l = o) : (o !== s && o + 1 !== s) || (l = s - 1), l <
								0 && (l = null), null !== l && n.selectChip(l, r), s ||
								r.find("input").focus();
						} else if (37 === i.which) {
							...
							if (
								((o = a.index() + 1), t(e.CHIP).removeClass("selected"), o > s)
							)
				...
				.on("focusin.chips", e.CHIPS + " " + e.INPUT, function(i) {
					...
					n.addClass(
						"focus"
					), n.siblings("label, .prefix").addClass("active"), t(e.CHIP).removeClass("selected");
				}), n.$document
				...
				.on("focusout.chips", e.CHIPS + " " + e.INPUT, function(i) {
					...
					n.removeClass(
						"focus"
					), (void 0 !== n.data("chips") && n.data("chips").length) || n.siblings("label").removeClass("active"), n.siblings(".prefix").removeClass("active");
				}), n.$document
			...
			if (e.tag) {
				...
				return i.text(e.tag), e.image &&
					i.prepend(t("<img />").attr("src", e.image)), i.append(
					t('<i class="material-icons close">close</i>')
				), i;
			}
			...
			if (n.isValid(e, t)) {
				for (
					...
					o.push(a[r]);
				o.push(t), e.data("chips", o), i.insertBefore(
					e.find("input")
				), e.trigger("chip.add", t), n.setPlaceholder(e);
			}
			...
			: (
					...
					this.each(function() {
						function i(t) {
							t.removeClass(
								"pin-top"
							), t.removeClass("pinned"), t.removeClass("pin-bottom");
						}
						function n(n, o) {
							n.each(function() {
								e.top <= o &&
									...
									), o < e.top && !t(this).hasClass("pin-top") && (i(t(this)), t(this).css("top", 0), t(this).addClass("pin-top")), o > e.bottom && !t(this).hasClass("pin-bottom") && (i(t(this)), t(this).addClass("pin-bottom"), t(this).css("top", e.bottom - r));
							});
						}
						var o = Materialize.guid(),
							a = t(this),
							r = t(this).offset().top;
						t(this).data("pushpin-id", o), n(a, t(window).scrollTop()), t(
							window
						).on("scroll." + o, function() {
	...
	var e = function(e) {
			...
			if (!1 === i.hasClass("active")) {
				var n, o;
				!0 === i.hasClass("horizontal") ? (o = 40) : (n = 40), i.addClass(
					"active"
				), i
		...
		i = function(t) {
			var e,
				i,
				n = t;
			!0 === n.hasClass("horizontal") ? (i = 40) : (e = 40), n.removeClass(
				"active"
			);
			n.find("ul .btn-floating").velocity("stop", !0), n
				.find("ul .btn-floating")
				.velocity(
					{
						opacity: "0",
		...
		n = function(e) {
			if ("true" !== e.attr("data-open")) {
				...
				c.append(d), (i = l.left - r / 2 + l.width / 2), (n =
					s - l.bottom), (a = r / d.width()), e.attr(
					"data-origin-bottom",
					l.bottom
				), e.attr("data-origin-left", l.left), e.attr(
					"data-origin-width",
					l.width
				), e.addClass("active"), e.attr("data-open", !0), e.css({
					"text-align": "center",
					width: "100%",
					bottom: 0,
					left: 0,
					...
					e.css({
						...
						e.css({
							overflow: "hidden",
							"background-color": p
						}), d.css({ transform: "scale(" + a + ")", transition: "transform .2s cubic-bezier(0.550, 0.055, 0.675, 0.190)" }), u.find("> li > a").css({ opacity: 1 }), t(
							window
						).on("scroll.fabToolbarClose", function() {
							o(
								e
							), t(window).off("scroll.fabToolbarClose"), t(document).off("click.fabToolbarClose");
			...
			if ("true" === t.attr("data-open")) {
				...
				(e = s - n / 2 + a / 2), (i = o - r), n / u.width(), t.removeClass(
					...
					u.remove(), t.css({ "text-align": "", width: "", bottom: "", left: "", overflow: "", "background-color": "", transform: "translate3d(" + -e + "px,0,0)" }), l.css({ overflow: "", transform: "translate3d(0," + i + "px,0)" }), setTimeout(function() {
						...
						}), l.css({ transform: "translate3d(0,0,0)", transition: "transform .2s cubic-bezier(0.550, 0.055, 0.675, 0.190)" });
					}, 20);
				}, 200);
			}
		};
	...
	(Materialize.fadeInImage = function(e) {
		...
		var n = 0;
		i.find("li").velocity({ translateX: "-100px" }, { duration: 0 }), i
			.find("li")
			.each(function() {
				t(this).velocity(
	...
	function e(a, s, u, d) {
		...
		function h() {
			x
				...
				.attr("tabindex", -1)
				.val(
					x.data("value") ? T.get("select", w.format) : a.value
				), w.editable ||
				x
				...
				.on(
					...
					function() {
						var e = t(this),
							...
							o = r();
						(o = o && (o.type || o.href) && o), (n ||
							(o && !t.contains(T.$root[0], o))) &&
		...
		function v() {
			...
			!0 === w.hiddenName
				...
				: (e =
						...
						a.name +
						e[1]), (T._hidden = t('<input type=hidden name="' + e + '"' + (x.data("value") || a.value ? ' value="' + T.get("select", w.formatSubmit) + '"' : "") + ">")[0]), x.on(
				"change." + b.id,
				function() {
			...
			T = (C.prototype = {
				...
				render: function(t) {
					return t
						...
						: T.$root
								.find("." + k.box)
								.html(T.component.nodes(b.open)), T.trigger("render");
				},
				stop: function() {
					return b.start
						? (
				...
				get: function(t, i) {
					...
					if (t in T.component.item) {
						if ("string" == typeof i) {
							...
							return n
								? e._.trigger(T.component.formats.toString, T.component, [i, n])
								: "";
						}
				...
				on: function(e, i, n) {
					...
					if (e) {
						r || (s[e] = i);
						for (o in s)
							(a = s[o]), n && (o = "_" + o), (b.methods[o] =
								b.methods[o] || []), b.methods[o].push(a);
					}
					return T;
				},
				off: function() {
	...
	function i(t) {
		...
		return t.currentStyle
			...
			: window.getComputedStyle &&
				(e = getComputedStyle(t).position), "fixed" == e;
	}
	function n() {
	...
	return (e.klasses = function(t) {
		...
		group: function(t) {
			for (
				...
				(i = e._.trigger(t.item, t, [o])), (n += e._.node(
					t.node,
					i[0],
					i[1],
					i[2]
			...
			.on(
				...
				function() {
					...
					i.disabled(i.get("now")) &&
						(n = ":not(." + e.klass.buttonToday + ")"), t.$root
	...
	(i.prototype.set = function(t, e, i) {
		...
		var a,
			r = this;
		return (i = void 0 === i ? t : i), i == -1 / 0 || i == 1 / 0
			? (a = i)
		...
		return n.isInteger(t) || (t = a(t)), n.isInteger(i) ||
			(i = a(i)), n.isInteger(t) && e.isPlainObject(i)
			? (t = [i.year, i.month, i.date + t])
			: n.isInteger(i) &&
				e.isPlainObject(t) &&
				(i = [t.year, t.month, t.date + i]), { from: a(t), to: a(i) };
	}), (i.prototype.withinRange = function(t, e) {
		return (t = this.createRange(t.from, t.to)), e.pick >= t.from.pick &&
			e.pick <= t.to.pick;
	}), (i.prototype.overlapRanges = function(t, e) {
		var i = this;
		return (t = i.createRange(t.from, t.to)), (e = i.createRange(
			e.from,
			e.to
		...
		return (e = new Date()), i &&
			i.rel &&
			e.setDate(e.getDate() + i.rel), this.normalize(e, i);
		...
		if (l || c) {
			for (
				c
					...
					u &&
					u.month !== r &&
					((a = u.year), (r = u.month)), a = (o = new Date(
					a,
					r + (n && n.nav ? n.nav : 0),
					1
				)).getFullYear(), r = o.getMonth();
		...
		var e = this,
			...
			d = o.max,
			p = (function(t, e) {
				return i.firstDay && (t.push(t.shift()), e.push(e.shift())), n.node(
					"thead",
					n.node(
						"tr",
						n.group({
			...
			f = function(o) {
				...
				return "short_months" == o && (a = i.monthsShort), i.selectMonths &&
				void 0 == o
					? n.node(
							"select",
							n.group({
							...
							p +
								n.node(
									...
									n.group({
										...
										item: function(t) {
											var o =
												i.firstDay && 0 === e.create([l.year, l.month, 1]).day
													? -7
													: 0;
											return [
												n.group({
															...
															n.node(
																...
																(function(e) {
																	return e.push(
																		...
																		e.push(i.klass.now), o &&
																		e.push(i.klass.selected), p &&
																		e.push(i.klass.highlighted), h &&
																		e.push(i.klass.disabled), e.join(" ");
																})([i.klass.day]),
																"data-pick=" +
																	t.pick +
																	" " +
	...
	function o(o, r) {
		function l(t, e) {
			...
			if (!e || !(u < y - w || u > y + w)) {
				...
				E.setHand(l, c, !e, !0), s.off(h).on(h, function(t) {
					...
					(e || p) && n === l && u === c && E.setHand(n, u), "hours" ===
					E.currentView
						...
						: r.autoclose &&
							...
							), d.prepend(z), clearTimeout(v), E.popover.removeClass("clockpicker-moving"), s.off(h);
				});
			}
		}
		var u = t(C),
		...
		(this.id = n(
			"cp"
		)), (this.element = o), (this.holder = v), (this.options = r), (this.isAppended = !1), (this.isShown = !1), (this.currentView =
			"hours"), (this.isInput = P), (this.input = A), (this.label = O), (this.popover = u), (this.plate = d), (this.hoursView = m), (this.minutesView = T), (this.amPmBlock = S), (this.spanHours = u.find(
			".clockpicker-span-hours"
		)), (this.spanMinutes = u.find(
			".clockpicker-span-minutes"
		)), (this.spanAmPm = u.find(
			".clockpicker-span-am-pm"
		)), (this.footer = u.find(".picker__footer")), (this.amOrPm =
			"PM"), r.twelvehour &&
			(r.ampmclickable
				? (
						this.spanAmPm.empty(),
						t('<div id="click-am">AM</div>')
							.on("click", function() {
								E.spanAmPm
									...
									.addClass(
										"text-primary"
									), E.spanAmPm.children("#click-pm").removeClass("text-primary"), (E.amOrPm = "AM");
							})
						...
						t('<div id="click-pm">PM</div>')
							.on("click", function() {
								E.spanAmPm
									...
									.addClass(
										"text-primary"
									), E.spanAmPm.children("#click-am").removeClass("text-primary"), (E.amOrPm = "PM");
							})
							.appendTo(this.spanAmPm)
					)
				: (
			...
			.appendTo(this.footer), this.spanHours.click(
			t.proxy(this.toggleView, this, "hours")
		), this.spanMinutes.click(t.proxy(this.toggleView, this, "minutes")), A.on(
		...
		if (
			...
			var z = u.find(".clockpicker-canvas"),
				V = e("svg");
			V.setAttribute("class", "clockpicker-svg"), V.setAttribute(
				"width",
				k
			...
			var L = e("circle");
			L.setAttribute("class", "clockpicker-canvas-bearing"), L.setAttribute(
				"cx",
				0
			), L.setAttribute("cy", 0), L.setAttribute("r", 4);
			var j = e("line");
			j.setAttribute("x1", 0), j.setAttribute("y1", 0);
			var $ = e("circle");
			$.setAttribute("class", "clockpicker-canvas-bg"), $.setAttribute(
				"r",
				w
			), H.appendChild(j), H.appendChild($), H.appendChild(L), V.appendChild(
				H
			), z.append(
				V
			), (this.hand = j), (this.bg = $), (this.bearing = L), (this.g = H), (this.canvas = z);
		}
		a(this.options.init);
	}
	function a(t) {
	...
	var r = t(window),
		...
		c =
			...
			(function() {
				...
				return (e.innerHTML = "<svg/>"), (t =
					(e.firstChild && e.firstChild.namespaceURI) == l), (e.innerHTML =
					""), t;
			})(),
		u = (function() {
	...
	(o.DEFAULTS = {
		...
		if (!this.isShown) {
			...
			var n = this;
			this.input.blur(), this.popover.addClass(
				"picker--opened"
			), this.input.addClass("picker__input picker__input--active"), t(
				document.body
			).css("overflow", "hidden");
			var o = ((this.input.prop("value") || this.options.default || "") +
				"").split(":");
			if (
				(
				...
				(o = [l.getHours(), l.getMinutes()]), this.options.twelvehour &&
			...
			if (
				...
				this.options.container && c
					...
					: this.popover.insertAfter(this.input), this.options.twelvehour &&
					("PM" === this.amOrPm
						? (
			...
			this.toggleView(
				"hours"
			), this.locate(), (this.isShown = !0), s.on(
		...
		a(this.options.beforeHide), this.input.removeClass(
			"picker__input picker__input--active"
		), this.popover.removeClass("picker--opened"), t(document.body).css(
			"overflow",
			"visible"
		), (this.isShown = !1), t(":input").each(function(e) {
			t(this).attr("tabindex", e + 1);
		}), s.off(
			"click.clockpicker." + this.id + " focusin.clockpicker." + this.id
		), s.off("keyup.clockpicker." + this.id), this.popover.hide(), a(
		...
		(this.currentView = e), this.spanHours.toggleClass(
			"text-primary",
			o
		), this.spanMinutes.toggleClass("text-primary", !o), s.addClass(
			"clockpicker-dial-out"
		), r
			.css("visibility", "visible")
			.removeClass("clockpicker-dial-out"), this.resetClock(i), clearTimeout(
		...
		if (
			...
			var m = Math.sin(s) * (f - w),
				...
				k = Math.sin(s) * f,
				x = -Math.cos(s) * f;
			this.hand.setAttribute("x2", m), this.hand.setAttribute(
				"y2",
				g
			), this.bg.setAttribute("cx", k), this.bg.setAttribute("cy", x);
		} else
		...
		this.options.twelvehour && (e += this.amOrPm), this.input.prop(
			"value",
			e
		), e !== t &&
			(
			...
			), this.options.autoclose && this.input.trigger("blur"), a(
		...
		this.element.removeData("clockpicker"), this.input.off(
			"focus.clockpicker click.clockpicker"
		), this.isShown && this.hide(), this.isAppended &&
	...
	var e = {
		init: function(e) {
			...
			return this.each(function(i) {
				...
				function s(i) {
					(E = !0), j.hasClass("scrolling") || j.addClass("scrolling"), null != H && window.clearTimeout(H), (H = window.setTimeout(
						function() {
				...
				function l() {
					...
					(e =
						(t = Date.now()) -
						I), (I = t), (i = b - M), (M = b), (O = 0.8 * (1e3 * i / (1 + e)) + 0.2 * O);
				}
				function c() {
					var t, i;
					P &&
				...
				function d(t) {
					...
					W ||
						(e < 0
							...
							: e > 0 &&
								Math.abs(e - C) < e &&
								(e -= C)), e < 0 ? j.trigger("carouselNext", [Math.abs(e)]) : e > 0 && j.trigger("carouselPrev", [e]);
				}
				function p(e) {
					"mousedown" === e.type &&
						t(e.target).is("img") &&
						e.preventDefault(), (k = !0), (q = !1), (z = !1), (T = o(e)), (S = a(e)), (O = P = 0), (M = b), (I = Date.now()), clearInterval(D), (D = setInterval(l, 100));
				}
				function h(t) {
					var e, i;
					if (k)
						if (
							((e = o(t)), (y = a(t)), (i = T - e), Math.abs(S - y) < 30 && !z)
						)
				...
				function f(t) {
					if (k)
						return (k = !1), clearInterval(D), (A = b), (O > 10 || O < -10) &&
							(A = b + (P = 0.9 * O)), (A = Math.round(A / x) * x), W &&
							(A >= x * (C - 1) ? (A = x * (C - 1)) : A < 0 && (A = 0)), (P =
							A - b), (I = Date.now()), requestAnimationFrame(c), q &&
				...
				if (
					...
					return t(window).trigger("resize"), j.trigger("carouselNext", [
						1e-6
					]), !0;
				j.addClass(
					"initialized"
				), (k = !1), (b = A = 0), (v = []), (m = j.find(".carousel-item").first().innerWidth()), (g = j.find(".carousel-item").first().innerHeight()), (x = 2 * m + e.padding), j.find(".carousel-item").each(function(e) {
				...
				}), N && j.append(V), (C = v.length), (_ = "transform"), [
					"webkit",
					"Moz",
					"O",
					"ms"
				...
				t(window)
					...
					.on(
						"resize.carousel-" + F,
						X
					), void 0 !== window.ontouchstart && (j.on("touchstart.carousel", p), j.on("touchmove.carousel", h), j.on("touchend.carousel", f)), j.on("mousedown.carousel", p), j.on("mousemove.carousel", h), j.on("mouseup.carousel", f), j.on("mouseleave.carousel", f), j.on("click.carousel", u), s(b), t(
					this
				).on("carouselNext", function(t, e, i) {
					void 0 === e &&
						(e = 1), "function" == typeof i && (L = i), (A = x * Math.round(b / x) + x * e), b !== A && ((P = A - b), (I = Date.now()), requestAnimationFrame(c));
		...
		destroy: function() {
			...
			t(this).removeAttr("data-namespace"), t(this).removeClass(
				"initialized"
			), t(this).find(".indicators").remove(), t(this).off(
				"carouselNext carouselPrev carouselSet"
			), t(window).off("resize.carousel-" + e), void 0 !==
				window.ontouchstart &&
				t(this).off(
			...
			return this.each(function() {
				...
				o.length ||
					(o = n
						...
						.parent()), s.length || ((s = t('<div class="tap-target-content"></div>')), n.append(s)), a.length || ((a = t('<div class="tap-target-wave"></div>')), r.length || ((r = i.clone(!0, !0)).addClass("tap-target-origin"), r.removeAttr("id"), r.removeAttr("style"), a.append(r)), o.append(a));
				var l = function() {
						o.is(".open") &&
							(
								o.removeClass("open"),
					...
					c = function() {
						...
						var c = i.outerWidth(),
							...
							V = x / 2 - D / 2,
							H = {};
						(H.top = b ? T : ""), (H.right = y ? h - S - x : ""), (H.bottom = w
							? f - T - C
							: ""), (H.left = g ? S : ""), (H.position = P), o.css(H), s.css({
							width: A,
							height: O,
							top: E,
							right: 0,
